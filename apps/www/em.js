...
// Show SEs (+check control totals) -------------------------------------------
  ...
  // TABLE TAB ------------------------------------------------------------------
    ...
    // Caption, Citation, Notes ---------------------------------------------------
      var fullCaption, fullCaption2, fullCaption3, plotCaption, newSource, yearName_table, yearName_plot, yearName2  ;
...
//       $('#plot-caption2').text(plotCaption2);
      ...
      var newCitation = NCHS+". "+tableCaption+". "+NHIS+
        ...
        newSource = "<b>Source:</b> "+NCHS+", "+NHIS+", "+yearName_table;   
